...
<p>python pacman.py -l tinyMaze -p SearchAgent</p>
...
<p>python pacman.py -l mediumMaze -p SearchAgent</p>
...
<p>python pacman.py -l mediumMaze -p SearchAgent -a fn=bfs</p>
...
<p>python pacman.py -l bigMaze -p SearchAgent -a fn=bfs -z .5</p>
...
<p>python pacman.py -l mediumMaze -p SearchAgent -a fn=ucs</p>
...
<p>python pacman.py -l mediumDottedMaze -p StayEastSearchAgent</p>
...
<p>python pacman.py -l mediumScaryMaze -p StayWestSearchAgent</p>
